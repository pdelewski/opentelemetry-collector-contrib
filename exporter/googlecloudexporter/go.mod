...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/collector v0.32.0
...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/trace v1.8.0 // indirect
